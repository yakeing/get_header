...
[![Size](https://img.shields.io/github/size/yakeing/get_header/src/GetHeader.php.svg)](https://github.com/yakeing/get_header/blob/master/src/get_header/GetHeader.php)
